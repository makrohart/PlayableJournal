...
int pj::journal::JournalEngine::compileAndExecute(const char* scriptPath)
{
	v8::Isolate::Scope isolate_scope(m_pIsolate);
	bindJS2Native(m_pIsolate);
	bool success;
	{
...
void pj::journal::JournalEngine::initializeV8()
{
...
void pj::journal::JournalEngine::bindJS2Native(v8::Isolate* pIsolate)
{
...
bool pj::journal::JournalEngine::compileAndExecute(v8::Local<v8::String> source, v8::Local<v8::Value> name, bool print_result, bool report_exceptions)
{
	v8::HandleScope handle_scope(m_pIsolate);
...
void pj::journal::JournalEngine::reportException(v8::TryCatch* try_catch)
{
	v8::HandleScope handle_scope(m_pIsolate);
